...
export const TEAM_COLORS: Record<string, { primary: string; secondary: string; accent: string }> = {
  ...
  "Brooklyn Nets": { primary: "#000000", secondary: "#FFFFFF", accent: "#777D84" },
  ...
  "Phoenix Suns": { primary: "#1D1160", secondary: "#E56020", accent: "#000000" },
  ...
  "San Antonio Spurs": { primary: "#C4CED4", secondary: "#000000", accent: "#FFFFFF" },
  ...
  "San Francisco 49ers": { primary: "#AA0000", secondary: "#B3995D", accent: "#000000" },
  "Philadelphia Eagles": { primary: "#004C54", secondary: "#A5ACAF", accent: "#000000" },
  "Dallas Cowboys": { primary: "#003594", secondary: "#869397", accent: "#FFFFFF" },
  "Green Bay Packers": { primary: "#203731", secondary: "#FFB612", accent: "#FFFFFF" },
  "Baltimore Ravens": { primary: "#241773", secondary: "#9E7C0C", accent: "#000000" },
  ...
  "Atlanta Braves": { primary: "#CE1141", secondary: "#13274F", accent: "#EAAA00" },
  "Houston Astros": { primary: "#002D62", secondary: "#EB6E1F", accent: "#F4911E" },
  "Chicago Cubs": { primary: "#0E3386", secondary: "#CC3433", accent: "#FFFFFF" },
  "Boston Red Sox": { primary: "#BD3039", secondary: "#0C2340", accent: "#FFFFFF" },
};

/**
 * Get team colors with intelligent fallback
 */
export function getTeamColors(team: string, colorOverride?: string): {
  primary: string;
  secondary: string;
  accent: string;
} {
  ...
  for (const [key, val] of Object.entries(TEAM_COLORS)) {
    if (key.toLowerCase().includes(lower) || lower.includes(key.toLowerCase().split(" ").pop()!)) {
      return val;
    }
  }
  ...
  if (colorOverride) {
    return { primary: colorOverride, secondary: adjustBrightness(colorOverride, 30), accent: "#FFFFFF" };
  }
...
export function getTeamAbbr(team: string): string {
  ...
  const ABBR_MAP: Record<string, string> = {
    ...
    "NY Yankees": "NYY", "LA Dodgers": "LAD", "Atlanta Braves": "ATL",
  };
